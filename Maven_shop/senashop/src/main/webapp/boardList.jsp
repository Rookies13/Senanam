                    ...
                    <div class="table-wrapper">
                        <table border="1" align="center" width="100%">
                            <thead>
                                ...
                                <th width="52%" align="center"><center>제목</center></th>
                                <th width="15%" align="center"><center>글쓴이</center></th>
                                <th width="8%" align="center"><center>파일</center></th>
                            ...
                            try{
                                ...
                                while(rs.next()){
                                    ...
                                    {
                                        out.print("<td align=\"center\" > <img src = images/file.png>"+"</td>");
                                    }
                                    out.print("<td align=\"center\">" + rs.getDate("time") + "</td>");
                                    out.print("</tr>");
                                    count++;
                                }
